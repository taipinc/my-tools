...
export const categories: Category[] = [
  {
    ...
    tools: [
      ...
      },
      {
        ...
        blurb: 'Train a single perceptron and watch the decision boundary move.',
        status: 'live',
    ...
    tools: [
      {
        ...
        blurb: 'Rain, a bucket, and a metaphor for how exposure actually works.',
        status: 'live',
      },
    ],
  },
...
export function findTool(slug: string): { tool: Tool; category: Category } | undefined {
